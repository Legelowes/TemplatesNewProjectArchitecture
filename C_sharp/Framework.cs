...
// 	******************************************************************************************************************************************************
        ...
        {
            this.framework_Static_XxxxxxXxxxxx = new Static_Server_Backend(num_implemented_cores);
            while(this.framework_Static_XxxxxxXxxxxx == null) { }
            this.framework_Dynamic_XxxxxxXxxxxx = new Dynamic_Server_Backend(this.framework_Static_XxxxxxXxxxxx, num_implemented_cores);
...
//	REGISTERS ********************************************************************************************************************************************
// 	******************************************************************************************************************************************************
        private Static_Server_Backend framework_Static_XxxxxxXxxxxx;
        private Dynamic_Server_Backend framework_Dynamic_XxxxxxXxxxxx;
...
//	CONSTRUCTOR ******************************************************************************************************************************************
// 	******************************************************************************************************************************************************
        public Static_Server_Backend(int num_implemented_cores)
        {
// INSTANCE(S)
...
//	CONSTRUCTOR ******************************************************************************************************************************************
// 	******************************************************************************************************************************************************
        public Dynamic_Server_Backend(Static_Server_Backend static_obj, int num_implemented_cores)
        {
// INSTANCE(S)
...
// HREADED CORES
            ...
            //while (checkList_PriorToConcurrentLaunch(static_obj, this, num_implemented_cores) == false) {}
